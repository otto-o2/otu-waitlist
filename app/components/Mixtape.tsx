...
const Mixtape = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      setProgress(p => Math.max(0, Math.min(100, p + delta * 0.1)));
  ...
  return (
    <DeviceChassis
      chassisGradient="linear-gradient(160deg, #2B2D3A 0%, #1C1E28 55%, #13141C 100%)"
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #353848 0%, #22242E 50%, #2C2E3C 100%)",
                boxShadow: "0 8px 24px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.07), inset 0 -1px 0 rgba(0,0,0,0.4)",
            ...
            >
              {Array.from({ length: 24 }).map((_, i) => (
                <div
                  key={i}
                  className="absolute"
                  style={{ width: "100%", height: "100%", top: 0, left: 0, transform: `rotate(${i * 15}deg)` }}
                >
                  <div
                    style={{
                      position: "absolute",
                      ...
                      background: i % 6 === 0 ? "rgba(255,255,255,0.14)" : "rgba(255,255,255,0.05)",
                      borderRadius: 1,
                    }}
                  />
                </div>
            ...
            <span
              ...
              style={{
                ...
                color: "rgba(210,220,235,0.3)", fontFamily: "'Outfit', sans-serif", whiteSpace: "nowrap",
              }}
            >
              flora
            </span>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 4px 14px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 0 1px rgba(255,255,255,0.04)",
              }}
            >
              <div
                style={{
      ...
      engravingText="otu flora"
      engravingColor="#D4DCE8"
    >
      {/* Status row */}
      <div className="flex justify-between items-center relative z-20">
        <span
          style={{
            ...
            letterSpacing: "0.18em", color: "rgba(180,200,210,0.5)", fontFamily: "'Outfit', sans-serif",
          }}
        >
          now playing
        </span>
        <div className="flex items-center gap-1">
          ...
          <div className="w-5 h-[9px] rounded-[2px] relative" style={{ border: "1px solid rgba(180,200,210,0.2)" }}>
            <div className="absolute inset-y-[2px] left-[2px] rounded-[1px]" style={{ width: "70%", background: "rgba(156,167,100,0.55)" }} />
            <div className="absolute right-[-4px] top-1/2 -translate-y-1/2 w-[3px] h-[5px] rounded-r-[1px]" style={{ background: "rgba(180,200,210,0.2)" }} />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center mt-1 relative z-20">
        <span
          style={{
            ...
            color: "rgba(215,230,240,0.92)", fontFamily: "'Outfit', sans-serif",
          }}
        >
          Xylem Drift
        </span>
        <span
          style={{
            ...
            color: "rgba(156,167,100,0.5)", fontFamily: "'Outfit', sans-serif",
          }}
        >
      ...
      {/* Waveform */}
      <div className="flex-1 flex items-end justify-center gap-[2px] px-1 pb-1 mt-1 relative z-20">
        {activeBars.map((h, i) => (
          <div
            key={i}
            style={{
              ...
              borderRadius: "2px",
              background: i < Math.floor((progress / 100) * NUM_BARS)
      ...
      {/* Progress bar */}
      <div className="w-full h-[2px] rounded-full overflow-hidden relative z-20" style={{ background: "rgba(180,200,210,0.08)" }}>
        <div className="h-full rounded-full" style={{ width: `${progress}%`, background: "rgba(156,167,100,0.7)", transition: "width 0.08s linear" }} />
      </div>
