...
export default function TermsOfService() {
  return (
    <div className="relative min-h-screen bg-[#0A0F0A] text-[#F1E8C7] overflow-hidden selection:bg-[#9CA764] selection:text-[#0A0F0A]">
      ...
      {/* Navigation Pill */}
      <nav className="relative z-50 p-6 md:p-12 mb-8">
        <Link 
          href="/" 
      ...
      {/* Main Content Area */}
      <main className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-32">
        <div className="bg-[#111A11] border border-[#9CA764]/20 rounded-[40px] md:rounded-[80px] shadow-2xl p-8 md:p-16 lg:p-24 backdrop-blur-sm">
          
          <div className="flex flex-col gap-6 mb-16 border-b border-[#9CA764]/20 pb-12">
            <h2 className="font-mono tracking-[0.3em] uppercase text-[#9CA764] text-xs md:text-sm">OTU</h2>
          ...
          <div className="prose prose-invert max-w-none text-[#F1E8C7]/80 font-sans text-lg md:text-xl leading-relaxed space-y-8">
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-4">Hi. Read this before we get started.</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">What Otu Is</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">What Otu Is Not</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Your Account</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">How to Use Otu (And How Not To)</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Our Stuff (Intellectual Property)</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Your Stuff (User Content)</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">The Waitlist</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">The Fine Print (Disclaimers)</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Limitation of Liability</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Ending Things</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Changes to These Terms</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Governing Law</h3>
            ...
            <h3 className="text-2xl font-bold text-[#F1E8C7] tracking-wide lowercase pt-8">Talk to Us</h3>
            ...
            <div className="pt-16 mt-16 border-t border-[#9CA764]/20 flex flex-col gap-2">
