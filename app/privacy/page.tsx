...
export default function PrivacyPolicy() {
  return (
    <div className="relative min-h-screen bg-[#F1E8C7] text-[#0A0F0A] overflow-hidden selection:bg-[#9CA764]/30 selection:text-[#0A0F0A]">
      ...
      <main className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-32">
        <div className="bg-[#FAF8ED] border border-black/5 rounded-[40px] md:rounded-[80px] shadow-2xl p-8 md:p-16 lg:p-24 backdrop-blur-sm">
          
          <div className="flex flex-col gap-6 mb-16 border-b border-black/10 pb-12">
            <h2 className="font-mono tracking-[0.3em] uppercase text-[#9CA764] text-xs md:text-sm mix-blend-multiply">OTU</h2>
          ...
          <div className="prose prose-stone max-w-none text-[#0A0F0A]/80 font-sans text-lg md:text-xl leading-relaxed space-y-8">
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-4">Hey. Before you go any further.</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Who We Are</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">What We Collect</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Why We Collect It</h3>
            <ul className="list-none space-y-4 pl-0">
              <li className="flex items-start gap-4">
                <span className="text-[#9CA764] mt-1">🌱</span>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Who Sees Your Data</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">What We Don’t Do With It</h3>
            <ul className="list-none space-y-4 pl-0">
              <li className="flex items-start gap-4">
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">How We Store It</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">How Long We Keep It</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Your Rights</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">A Note on Age</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Consent on the Form</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Changes to This Policy</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">The Legal Bit We Have to Say</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0A0F0A] tracking-wide lowercase pt-8">Talk to Us</h3>
            ...
            <div className="pt-16 mt-16 border-t border-black/10 flex flex-col gap-2">
